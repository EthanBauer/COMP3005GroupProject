        ...
        for entry in data:
            if entry['competition']['competition_id'] in comps and entry['season']['season_name'] in seasons: 
                ...
                match_data = {
                    ...
                    'competition': entry['competition']['competition_name'],
                ...
                cursor.execute('''
                        INSERT INTO matches (match_id, match_date, kick_off, competition, competition_id, season, season_id,
                        ...
                        VALUES (%(match_id)s, %(match_date)s, %(kick_off)s, %(competition)s, %(competition_id)s, %(season)s, %(season_id)s,
